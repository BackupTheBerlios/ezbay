...
#articles
INSERT INTO article (id, envente, libelle, marque, modele, prixvente, anneefabrication, description, datelimite, categorie_id, vendeur_id, nbEncheres, vendeurPseudo, vendeurId, vendeurMembreId) VALUES('axel_article1', '0' , 'DVD', 'Pathé', 'DVD', '2.00', '2004', 'Les Simpsons en folie', '2006-04-16', 'cine', 'axel_vendeur', 0, 'axel', 'axel_vendeur', 'axel_membre');
...
INSERT INTO article (id, envente, libelle, marque, modele, prixvente, anneefabrication, description, datelimite, categorie_id, vendeur_id, nbEncheres, vendeurPseudo, vendeurId, vendeurMembreId) VALUES('axel_article4', '0' , 'DVD', 'Pathé', 'DVD', '4.00', '2003', 'Les Simpsons en folie 2', '2006-04-09', 'cine', 'axel_vendeur', 0, 'axel', 'axel_vendeur', 'axel_membre');
...
INSERT INTO article (id, envente, libelle, marque, modele, prixvente, anneefabrication, description, datelimite, categorie_id, vendeur_id, nbEncheres, vendeurPseudo, vendeurId, vendeurMembreId) VALUES('lotfi_article3', '0' , 'DVD', 'Gaumont', 'DVD', '3.00', '2006', 'Les Simpsons : back to the future', '2006-04-14', 'cine', 'lotfi_vendeur', 0, 'lotfi', 'lotfi_vendeur', 'lotfi_membre');
INSERT INTO article (id, envente, libelle, marque, modele, prixvente, anneefabrication, description, datelimite, categorie_id, vendeur_id, nbEncheres, vendeurPseudo, vendeurId, vendeurMembreId) VALUES('lotfi_article4', '0' , 'DVD', 'Gaumont', 'DVD', '5.00', '2005', 'Les SImpsons : the best', '2006-04-12', 'cine', 'lotfi_vendeur', 0, 'lotfi', 'lotfi_vendeur', 'lotfi_membre');

INSERT INTO article (id, envente, libelle, marque, modele, prixvente, anneefabrication, description, datelimite, categorie_id, vendeur_id, nbEncheres, vendeurPseudo, vendeurId, vendeurMembreId) VALUES('sofi_article1', '0' ,'DVD', 'Pathé', 'DVD', '2.00', '2002', 'La famille Simpson T1', '2006-04-09', 'cine', 'sofi_vendeur', 0, 'sofi', 'sofi_vendeur', 'sofi_membre');
INSERT INTO article (id, envente, libelle, marque, modele, prixvente, anneefabrication, description, datelimite, categorie_id, vendeur_id, nbEncheres, vendeurPseudo, vendeurId, vendeurMembreId) VALUES('sofi_article2', '0', 'DVD', 'Pathé', 'DVD', '3.00', '2002', 'description de article 32', '2006-04-12', 'cine', 'sofi_vendeur', 0, 'sofi', 'sofi_vendeur', 'sofi_membre');
