...
/**
 * Value object for Categorie.
 *
 * Notice, this object is used to represent the state of an 
 * Categorie object. This value object
   ...
   implements java.io.Serializable, java.lang.Cloneable 
{
   ...
   public CategorieDTO( java.lang.String id,java.lang.String libelle )
   {
       setId(id);
       setLibelle(libelle);
    ...
    */
   public CategorieDTO( CategorieDTO otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("id=" + getId() + " " + "libelle=" + getLibelle());
	  str.append('}');
   ...
   {
          if (other instanceof CategorieDTO)
          {
                 CategorieDTO that = (CategorieDTO) other;
    ...
    public boolean equals(Object other) {
        ...
        return equals((CategorieDTO) other);
    }
     ...
     */
    public boolean equals(CategorieDTO that) {
    ...
    public Object clone() throws java.lang.CloneNotSupportedException {
        CategorieDTO other = (CategorieDTO) super.clone();

        return other;
    }

    public ReadOnlyCategorieDTO getReadOnlyCategorieDTO() {
        return new ReadOnlyCategorieDTO();
    }
    ...
    private final class ReadOnlyCategorieDTO 
    implements java.lang.Cloneable, java.io.Serializable 
    {
        private CategorieDTO underlying() {
            return CategorieDTO.this;
        }
       ...
       public java.lang.String getLibelle() {
        ...
        public boolean equals(Object o) {
            if(o instanceof ReadOnlyCategorieDTO) {
                return this.equals((ReadOnlyCategorieDTO) o);
            }
            return false;
        }

        public boolean equals(ReadOnlyCategorieDTO that) {
            if(null == that) {
                return false;
            }
