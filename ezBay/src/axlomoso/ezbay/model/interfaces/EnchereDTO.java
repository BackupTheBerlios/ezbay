...
/**
 * Value object for Enchere.
 *
 * Notice, this object is used to represent the state of an 
 * Enchere object. This value object
   ...
   implements java.io.Serializable, java.lang.Cloneable 
{
   ...
   public EnchereDTO( java.lang.String id,java.util.Date date,java.lang.Double montant,java.util.Date dateLimite )
   {
       setId(id);
       setDate(date);
       setMontant(montant);
    ...
    */
   public EnchereDTO( EnchereDTO otherValue )
   {
   ...
   {
          if (other instanceof EnchereDTO)
          {
                 EnchereDTO that = (EnchereDTO) other;
    ...
    public boolean equals(Object other) {
        ...
        return equals((EnchereDTO) other);
    }
     ...
     */
    public boolean equals(EnchereDTO that) {
    ...
    public Object clone() throws java.lang.CloneNotSupportedException {
        EnchereDTO other = (EnchereDTO) super.clone();

        return other;
    }

    public ReadOnlyEnchereDTO getReadOnlyEnchereDTO() {
        return new ReadOnlyEnchereDTO();
    }
    ...
    private final class ReadOnlyEnchereDTO 
    implements java.lang.Cloneable, java.io.Serializable 
    {
        private EnchereDTO underlying() {
            return EnchereDTO.this;
        }
       ...
       public java.util.Date getDateLimite() {
        ...
        public boolean equals(Object o) {
            if(o instanceof ReadOnlyEnchereDTO) {
                return this.equals((ReadOnlyEnchereDTO) o);
            }
            return false;
        }

        public boolean equals(ReadOnlyEnchereDTO that) {
            if(null == that) {
                return false;
            }
