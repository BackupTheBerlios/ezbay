			...
			<html:form action="/membreSave">
				<table class="body_affichage_donnees">
					...
					<tr>
						<td class="intitule">
							<b>
								<bean:message key="inscription.label.password1" />
								:
							</b>
						</td>
						<td>
					...
					<tr>
						<td class="intitule">
							<b>
								<bean:message key="inscription.label.password2" />
								:
							</b>
						</td>
						<td>
							<html:password property="password2" value="" />
						</td>
					</tr>
					<tr>
						<td class="intitule">
					...
					<tr>
						...
						<td>
							<html:text property="codePostal" maxlength="5" size="5" />
						</td>
					</tr>
					<tr>
						<td class="intitule">
					...
					<tr>
						...
						<td>
							<html:text property="telephoneFixe" maxlength="10" />
						</td>
					</tr>
					<tr>
						<td class="intitule">
						...
						<td>
							<html:text property="telephonePortable" maxlength="10" />
						</td>
					</tr>
					<tr>
						<td class="intitule">
						...
						<td>
							<html:text property="stringDateNaissance" size="10" maxlength="10" />
						</td>
					</tr>
				</table>
				<br />
